...
class Room < ApplicationRecord
  ...
  validates :voice_bridge, presence: false, length: { is: 5 }, numericality: { only_integer: true }, uniqueness: true if Rails.configuration.room_features.include? "phone-call"
